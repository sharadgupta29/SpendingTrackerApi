...
insert into expense(id, add_date_time, amount, purchase_date, update_date_time) 
values(5001,sysdate(),150,'2021-04-01',sysdate());

insert into expense(id, add_date_time, amount, purchase_date, update_date_time) 
values(5002,sysdate(),150,'2021-05-01',sysdate());

insert into expense(id, add_date_time, amount, purchase_date, update_date_time) 
values(5003,sysdate(),150,'2021-06-01',sysdate());

insert into expense(id, add_date_time, amount, purchase_date, update_date_time) 
values(5004,sysdate(),150,'2021-07-01',sysdate());